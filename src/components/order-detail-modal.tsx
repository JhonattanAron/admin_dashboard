...
import { Package, Truck, Factory, Clock, CheckCircle, AlertTriangle } from "lucide-react"
    ...
    timeline: [
      {
        ...
        description: "El pedido ha sido recibido y está pendiente de procesamiento.",
      },
      {
        date: "2023-04-01 14:30",
        status: "Pago confirmado",
        description: "El pago ha sido confirmado y el pedido está siendo procesado.",
      },
      {
      ...
      },
      {
        ...
        status: "Entregado",
        description: "El pedido ha sido entregado con éxito.",
      },
    ],
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Pedido realizado el {orderDetails.date} por {orderDetails.customer.name}
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="products" className="space-y-4 mt-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <Badge className={orderDetails.payment === "Pagado" ? "bg-green-500" : "bg-yellow-500"}>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Lista de productos incluidos en este pedido.</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                        ...
                        <TableCell>
                          <div className="flex items-center">
                            ...
                            <span className="capitalize">
                              {item.source === "proveedor" ? `${item.source}: ${item.supplier}` : item.source}
                              {item.source === "fabricación" && ` (${item.productionTime})`}
                            </span>
                          </div>
                        </TableCell>
                        <TableCell>
                ...
                <div className="flex justify-end mt-4">
                  <div className="text-right">
                    <p className="text-sm text-muted-foreground">Subtotal: ${(orderDetails.total - 10).toFixed(2)}</p>
                    <p className="text-sm text-muted-foreground">Envío: $10.00</p>
                    <p className="text-lg font-bold">Total: ${orderDetails.total.toFixed(2)}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="customer" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Datos de contacto y dirección de envío.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-medium">{orderDetails.customer.name}</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm">Email: {orderDetails.customer.email}</p>
                    <p className="text-sm">Teléfono: {orderDetails.customer.phone}</p>
                  </div>
                  <div>
                ...
                <div className="mt-4">
                  ...
                  <p className="text-sm">Método de envío: {orderDetails.shippingMethod}</p>
                  <p className="text-sm">Número de seguimiento: {orderDetails.trackingNumber}</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="timeline" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Seguimiento del estado del pedido a lo largo del tiempo.</CardDescription>
              </CardHeader>
              <CardContent>
